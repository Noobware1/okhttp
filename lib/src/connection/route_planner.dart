...
abstract class RoutePlanner {
  abstract final InternetAddress address;

  /// Follow-ups for failed plans and plans that lost a race.
  abstract final List<Plan> deferredPlans;
  ...
  bool hasNext(RealConnection? failedConnection);
...
class ConnectResult {
  ...
  bool get isSuccess => nextPlan == null && throwable == null;
}
